...
const RPC_URL = "https://rpc.basecamp.t.raas.gelato.cloud/ec38c9fffbfd4ed5ac3069d1eef0e84f";
...
export function ParaProvider({ children }: { children: React.ReactNode }) {
  ...
  const initializeViem = () => {
    ...
    const wallet = createParaViemClient(para, { account, chain: basecampTestnet, transport: http(RPC_URL) });
    const client = createPublicClient({ chain: basecampTestnet, transport: http(RPC_URL) });
